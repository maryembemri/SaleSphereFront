      ...
      <div className='modal-body py-lg-10 px-lg-10'>
        ...
        >
          ...
          <div className='flex-row-fluid py-lg-5 px-lg-15'>
            {/*begin::Form */}
            <form noValidate id='modal_create_app_form'>
              ...
              <div className='d-flex flex-stack pt-10'>
                <div className='me-2'>
                  <button
                    ...
                    onClick={prevStep}
                  >
                    <Icon iconName='arrow-left' className='fs-3 me-1' /> Previous
                  </button>
                </div>
                <div>
                  <button
                    ...
                    onClick={submit}
                  >
                    Submit <Icon iconName='arrow-right' className='fs-3 ms-2 me-0' />
                  </button>
                  ...
                  <button
                    ...
                    onClick={nextStep}
                  >
                    Next Step <Icon iconName='arrow-right' className='fs-3 ms-1 me-0' />
                  </button>
                </div>
              </div>
              {/*end::Actions */}

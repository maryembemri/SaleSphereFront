...
const HeaderNotificationsMenu: FC = () => (
  <div className='menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px' data-menu='true'>
    ...
    <div className='tab-content'>
      <div className='tab-pane fade' id='topbar_notifications_1' role='tabpanel'>
              ...
              <div className='d-flex align-items-center'>
                <div className='symbol symbol-35px me-4'>
                  <span className={clsx('symbol-label', `bg-light-${alert.state}`)}>
                    {' '}
                    <Icon iconName={alert.icon} className={`fs-2 text-${alert.state}`} />
                  </span>
                </div>
      ...
      <div className='tab-pane fade show active' id='topbar_notifications_2' role='tabpanel'>
      ...
      <div className='tab-pane fade' id='topbar_notifications_3' role='tabpanel'>
        <div className='scroll-y mh-325px my-5 px-8'>

  ...
  return (
    ...
    >
      <div className='modal-content'>
        {/* begin::Form */}
        <form ref={formRef} id='inbox_compose_form' onSubmit={() => console.log('submit')}>
          {/*begin::Header*/}
          ...
          <div className='d-block'>
            ...
            {/*begin::Message*/}
            <div id='inbox_compose_editor' className='border-0 h-125px h-lg-250px'></div>
            {/*end::Message*/}

            {/*begin::Attachments*/}
            <div className='dropzone dropzone-multi px-8 py-4' id='inbox_compose_attachments'>
          ...
          <div className='d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-top'>
            ...
            <div className='d-flex align-items-center me-3'>
              ...
              <a
                ...
                id='inbox_compose_attachments_select'
              >
                <Icon className='fs-1' iconName='cloud-add' />
              </a>
              <a href='#' className='btn btn-icon btn-active-light-primary'>
                <Icon className='fs-1' iconName='geolocation' />
              </a>
              {/*end::Other*/}
            </div>
            {/*end::Actions*/}
            ...
            <div className='d-flex align-items-center'>
              <button
                ...
                title='More actions'
              >
                <Icon className='fs-1' iconName='setting-2' />
              </button>
            </div>
            {/*end::Toolbar*/}
          </div>

...
const QuickLinks: FC = () => (
  <div className='menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px' data-menu='true'>
    <div
    ...
    <div className='row g-0'>
      <div className='col-6'>
        ...
        >
          <Icon iconName='euro' className='fs-3x text-primary mb-2' />
      ...
      <div className='col-6'>
        ...
        >
          <Icon iconName='sms' className='fs-3x text-primary mb-2' />
      ...
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end'>
          <Icon iconName='abstract-41' className='fs-3x text-primary mb-2' />
      ...
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light'>
          <Icon iconName='briefcase' className='fs-3x text-primary mb-2' />
    ...
    <div className='py-2 text-center border-top'>
      <Link to='/crafted/pages/profile' className='btn btn-color-gray-600 btn-active-color-primary'>
        View All <Icon iconName='arrow-right' className='fs-5' />
      </Link>
    </div>
  </div>
)

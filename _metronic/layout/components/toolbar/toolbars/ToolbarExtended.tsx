    ...
    <>
      <div className='d-flex align-items-center flex-shrink-0 me-5'>
        ...
        >
          <a href='#' className='btn btn-sm btn-icon'>
            <Icon iconName='plus-square' className='fs-2hx text-success' />
          </a>
        </div>
      </div>
      {/* end::Button */}
      ...
      <div className='d-flex align-items-center overflow-auto'>
        ...
        <div className='d-flex align-items-center'>
          ...
          >
            <Icon iconName='element-11' className='fs-3 text-primary' />
          </button>
          ...
          >
            <Icon iconName='row-horizontal' className='fs-3 text-gray-400' />
          </button>
        </div>
        {/* end::Actions */}
      </div>

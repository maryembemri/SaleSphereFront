...
const ClientsListSearchComponent = () => {
  ...
  // The goal is to only have the API call fire when client stops typing ...
  ...
  return (
    <div className='card-title flex-grow-1'>
      ...
      <div className='d-flex align-items-center w-100  my-1'>
        ...
        <input
          type='text'
          data-client-table-filter='search'
...
export {ClientsListSearchComponent}

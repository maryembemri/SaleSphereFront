  ...
  return (
    <>
      ...
      >
        ...
        <div className='px-7 py-5' data-client-table-filter='form'>
          <div className='mb-10'>
            <label className='form-label fw-bold'>Type de client:</label>
          ...
          <div className='d-flex justify-content-end'>
            <button
              ...
              data-client-table-filter='filter'
            >
              Reseter
            </button>
            <button
              ...
              data-menu-dismiss='true'
              data-client-table-filter='reset'
            >
              Appliquer
            </button>
          </div>

...
import {useClientResponseData, useClientResponseLoading} from '../core/ClientResponseProvider'

const ClientInformations = () => {
  const isLoading = useClientResponseLoading()
  const client = useClientResponseData()
  if (isLoading)
    return (
          ...
          <div className='card rounded-4 h-100'>
            <div className='card-header p-6 border-0 pb-2'>
              <div className='card-title d-flex flex-column gap-3 fw-bold'>
                ...
                <div className='fs-4 text-primary'>{client.name}</div>
              </div>
            </div>
            <div className='card-body px-6 pt-2 d-flex flex-column gap-3'>
              <div className='d-flex flex-column gap-3'>
                ...
                <div className='d-flex align-items-center border rounded-3 gap-3 p-1 text-dark'>
                  ...
                  <div className='flex-grow-1 fs-7 fw-bold'>{client.email || '--'}</div>
                  <a
              ...
              <div className='d-flex flex-column align-items-start pt-4'>
                <div className='d-flex align-items-center p-2'>
                  ...
                  {client.isExempt ? (
                    <div className='mx-2 flex-grow-1'>
                      <span className='text-muted fw-semibold fs-6'>Details Exonaration</span>
                      <span className='text-gray-800 text-hover-primary fw-bold d-block'>
                        {client.exemptNumber} - {client.exemptExpiration}
                      </span>
                    </div>
                  ) : (
                    <div className='mx-2 flex-grow-1'>
                ...
                <div className='d-flex align-items-center p-2'>
                  ...
                  <div className='mx-2 flex-grow-1'>
                    ...
                    <span className='text-gray-800 text-hover-primary fw-bold d-block'>
                      {client.isArchived ? 'Archivé' : 'Activé'}
                    </span>
                  </div>
                </div>
              </div>

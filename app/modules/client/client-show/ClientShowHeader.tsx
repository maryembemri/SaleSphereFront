          ...
          <div className='d-flex flex-column justify-content-between ps-4 py-2'>
            ...
            <div className='d-flex flex-column flex-xl-row align-items-xl-center gap-3'>
              <div className='d-flex align-items-center gap-3'>
                ...
                <span className='text-muted fw-blod'>{client.email || '--'}</span>
              </div>
              {client.phone ? (
                <div className='d-flex align-items-center justify-content-center gap-3'>
                  <a
                  ...
                  <div className='flex-grow-1 text-muted fw-blod'>
                    <div className='d-inline-block'>{client.phone || '--'}</div>
                  </div>
                </div>
              ) : (
                <div className='d-flex align-items-center justify-content-center gap-3'>
              ...
              {client.mobile && (
                <div className='d-flex align-items-center justify-content-center gap-3'>
                  ...
                  <div className='flex-grow-1 text-muted fw-blod'>
                    <div className='d-inline-block'>{client.mobile}</div>
                  </div>
                </div>
              )}
            </div>
...
export default ClientShowHeader

...
const SignInMethod: React.FC = () => {
  ...
  return (
    <div className='card mb-5 mb-xl-10'>
      ...
      <div id='account_signin_method' className='collapse show'>
        <div className='card-body border-top p-9'>
          <div className='d-flex flex-wrap align-items-center'>
            <div id='signin_email' className={' ' + (showEmailForm && 'd-none')}>
            ...
            >
              ...
              >
                ...
                <div className='d-flex'>
                  <button id='signin_submit' type='submit' className='btn btn-primary  me-2 px-6'>
            ...
            <div id='signin_email_button' className={'ms-auto ' + (showEmailForm && 'd-none')}>
              <button
                onClick={() => {
          ...
          <div className='d-flex flex-wrap align-items-center mb-10'>
            <div id='signin_password' className={' ' + (showPasswordForm && 'd-none')}>
            ...
            >
              ...
              >
                ...
                <div className='d-flex'>
                  <button id='password_submit' type='submit' className='btn btn-primary me-2 px-6'>
          ...
          <div className='notice d-flex bg-light-primary rounded border-primary border border-dashed p-6'>
            <Icon iconName='shield-tick' className='fs-2tx text-primary me-4' />
            <div className='d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap'>
              ...
              <a
                ...
                data-bs-target='#modal_two_factor_authentication'
              >
                Enable
              </a>
            </div>

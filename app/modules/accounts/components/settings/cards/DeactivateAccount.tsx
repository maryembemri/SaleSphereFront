...
const DeactivateAccount: React.FC = () => {
  ...
  return (
    <div className='card'>
      ...
      <div id='account_deactivate' className='collapse show'>
        <form onSubmit={formik.handleSubmit} id='account_deactivate_form' className='form'>
          <div className='card-body border-top p-9'>
            <div className='notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6'>
              <Icon iconName='information-5' className='fs-2tx text-warning me-4' />

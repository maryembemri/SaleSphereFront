          ...
          <div className='mb-8 row'>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_1'>
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_2'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_3'>
          ...
          <div className='mb-8 row'>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_4'>
                  Upon new order
                </label>
              </div>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_5'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_6'>
                  Member registration
                </label>
              </div>
            </div>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  type='checkbox'
                  id='checkbox_7'
                  checked={data.updatesFromKeenthemes.newsAboutArticles}
                  onChange={() =>
                    updateData({
                      updatesFromKeenthemes: {
                        ...data.updatesFromKeenthemes,
                        newsAboutArticles: !data.updatesFromKeenthemes.newsAboutArticles,
                      },
                    })
                  }
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_7'>
                  News about Keenthemes articles and feature updates
                </label>
              </div>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_8'>
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_9'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  type='checkbox'
                  id='checkbox_10'
                  checked={data.updatesFromKeenthemes.newsAboutPartners}
                  onChange={() =>
                    updateData({
                      updatesFromKeenthemes: {
                        ...data.updatesFromKeenthemes,
                        newsAboutPartners: !data.updatesFromKeenthemes.newsAboutPartners,
                      },
                    })
                  }
                />
                <label className='form-check-label fw-bold text-gray-600' htmlFor='checkbox_10'>
                  News about Keenthemes on partner articles and other services
                </label>
              </div>
            </div>
          </div>

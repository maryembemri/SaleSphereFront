            ...
            <div className='d-flex justify-content-between align-items-start flex-wrap mb-2'>
              <div className='d-flex flex-column'>
                <div className='d-flex align-items-center mb-2'>
                  ...
                  <a href='#'>
                    <Icon iconName='verify' className='fs-1 text-primary' />
                  </a>
                </div>
                ...
                <div className='d-flex flex-wrap fw-bold fs-6 mb-4 pe-2'>
                  ...
                  >
                    <Icon iconName='profile-circle' className='fs-4 me-1' />
                    Developer
                  </a>
                  <a
                    href='#'
                    className='d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2'
                  >
                    <Icon iconName='geolocation' className='fs-4 me-1' />
                    SF, Bay Area
                  </a>
                  <a
                    href='#'
                  ...
                  >
                    <Icon iconName='sms' className='fs-4 me-1' />
                    max@kt.com
                  </a>
                </div>
              </div>
              ...
              <div className='d-flex my-4'>
                <a href='#' className='btn btn-sm btn-light me-2' id='user_follow_button'>
                  <Icon iconName='check' className='fs-3 d-none' />
                ...
                <div className='d-flex flex-wrap'>
                  <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                    <div className='d-flex align-items-center'>
                      <Icon iconName='arrow-up' className='fs-3 text-success me-2' />
                  ...
                  <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                    <div className='d-flex align-items-center'>
                      <Icon iconName='arrow-down' className='fs-3 text-danger me-2' />

...
const UserEditModalForm: FC<Props> = ({user, isUserLoading}) => {
  ...
  return (
    <>
      <form id='modal_add_user_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
          ...
          <div className='mb-7'>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/* end::Input */}
                {/* begin::Label */}
                <label className='form-check-label' htmlFor='modal_update_role_option_0'>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <input
                  ...
                  type='radio'
                  value='Developer'
                  id='modal_update_role_option_1'
                  checked={formik.values.role === 'Developer'}
                  disabled={formik.isSubmitting || isUserLoading}
                />
                {/* end::Input */}
                {/* begin::Label */}
                <label className='form-check-label' htmlFor='modal_update_role_option_1'>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/* end::Input */}
                {/* begin::Label */}
                <label className='form-check-label' htmlFor='modal_update_role_option_2'>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <input
                  ...
                  type='radio'
                  value='Support'
                  id='modal_update_role_option_3'
                  checked={formik.values.role === 'Support'}
                  disabled={formik.isSubmitting || isUserLoading}
                />
                {/* end::Input */}
                {/* begin::Label */}
                <label className='form-check-label' htmlFor='modal_update_role_option_3'>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/* end::Input */}
                {/* begin::Label */}
                <label className='form-check-label' htmlFor='modal_update_role_option_4'>

...
import {QueryRequestContextProps, initialQueryState} from '../../core/_init'
  ...
  return (
    <div className='row'>
      ...
      <div className='col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end'>
        <div id='table_articles_paginate'>
                ...
                <li
                  ...
                  className={clsx('page-item', {
                    ...
                    disabled:
                      ...
                      (link.label === 'Next' && pagination.page === pagination.links?.length! - 2),
...
export {SuppliersListPagination}
